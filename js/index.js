angular.module("resume", []).factory("LanguagesService", function () {
  return {
    languages: ["HTML", "CSS", "Javascript"]
  };
}).controller("LanguagesCtrl", function ($scope, LanguagesService) {
  ...
  return {
    clients: [{
      ...
      "highlights": ["Designed cross-browser and resolution-friendly website interfaces", "Managed all of the front-end code on their new $150 million CMS", "Specialized in writing SEO optimized code for their clients’ products"]
    }, {
      "name": "StarCite",
      ...
      "highlights": ["Wrote the HTML/CSS for their company intranet running on Confluence", "Built out numerous Flash and Gif animated ads", "Built out HTML/CSS emails to work in older versions of Outlook"]
    }, {
      "name": "Concept 64, Inc.",
      ...
      "highlights": ["Worked with Empathy Lab on designing their Fuji Bikes for Women portal", "Designed numerous sites to run on Wordpress"]
    }]
  };
